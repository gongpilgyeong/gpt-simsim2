...
class SlackIO(MonoWorker):
    """Non-blocking file-like IO using a Slack chat."""
...
class tqdm_slack(tqdm_auto):
    """
    Standard `tqdm.auto.tqdm` but also sends updates to a Slack chat.
    May take a few seconds to create (`__init__`).

    - create a Slack chat with the `chat:write` scope & invite it to a
