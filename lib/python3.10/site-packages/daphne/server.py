...
class Server:
    ...
    def application_checker(self):
        ...
        for protocol, details in list(self.connections.items()):
            ...
            # First, see if the protocol disconnected and the chat has taken
            ...
            # Then see if the chat is done and we should reap it
            ...
            # Check to see if protocol is closed and chat is closed so we can remove it
