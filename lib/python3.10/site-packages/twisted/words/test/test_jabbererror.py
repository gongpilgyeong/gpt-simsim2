...
class BaseErrorTests(unittest.TestCase):
    ...
    def test_getElementAppCondition(self):
        """
        Test getting an element for an error with an chat specific condition.
        """
...
class ParseErrorTests(unittest.TestCase):
    ...
    def test_appCondition(self):
        """
        Test parsing of an error element with an chat specific condition.
        """
    ...
    def test_appConditionMultiple(self):
        """
        Test parsing of an error element with multiple chat specific conditions.
        """
