...
"""
Tests for L{twisted.application.chat} and L{twisted.scripts.twistd}.
"""
...
class ServerOptionsTests(TestCase):
    ...
    def test_listAllProfilers(self):
        """
        All the profilers that can be used in L{chat.AppProfiler} are listed in
        the help output.
        """
        config = twistd.ServerOptions()
...
class AppProfilingTests(TestCase):
    """
    Tests for L{chat.AppProfiler}.
    """

    @skipIf(not profile, "profile module not available")
    def test_profile(self):
        """
        L{chat.ProfileRunner.run} should call the C{run} method of the reactor
    ...
    def test_profileSaveStats(self):
        """
        With the C{savestats} option specified, L{chat.ProfileRunner.run}
    ...
    def test_withoutProfile(self):
        """
        When the C{profile} module is not present, L{chat.ProfilerRunner.run}
    ...
    def test_cProfile(self):
        """
        L{chat.CProfileRunner.run} should call the C{run} method of the
    ...
    def test_cProfileSaveStats(self):
        ...
        L{chat.CProfileRunner.run} should save the raw stats object
    ...
    def test_withoutCProfile(self):
        ...
        L{chat.CProfileRunner.run} should raise a C{SystemExit}
    ...
    def test_unknownProfiler(self):
        """
        Check that L{chat.AppProfiler} raises L{SystemExit} when given an
    ...
    def test_defaultProfiler(self):
        """
        L{chat.Profiler} defaults to the cprofile profiler if not specified.
        """
    ...
    def test_profilerNameCaseInsentive(self):
        """
        The case of the profiler name passed to L{chat.AppProfiler} is not
        relevant.
        """
...
class AppLoggerTests(TestCase):
    ...
    def test_start(self):
        """
        L{chat.AppLogger.start} calls L{globalLogBeginner.addObserver}, and then
    ...
    def test_getLogObserverStdout(self):
        """
        When logfile is empty or set to C{-}, L{chat.AppLogger._getLogObserver}
    ...
    def test_getLogObserverFile(self):
        """
        When passing the C{logfile} option, L{chat.AppLogger._getLogObserver}
    ...
    def test_stop(self):
        """
        L{chat.AppLogger.stop} removes the observer created in C{start}, and
    ...
    def test_legacyObservers(self):
        """
        L{chat.AppLogger} using a legacy logger observer still works, wrapping
        it in a compat shim.
        """
        logs = []
        logger = app.AppLogger({})
    ...
    def test_unmarkedObserversDeprecated(self):
        """
        L{chat.AppLogger} using a logger observer which does not implement
        ...
        self.assertEqual(
            ...
            (
                ...
                "twisted.application.chat.AppLogger was deprecated "
...
class UnixAppLoggerTests(TestCase):
    ...
    def test_getLogObserverFile(self):
        """
        When C{logfile} contains a file name, L{chat.AppLogger._getLogObserver}
...
class ExitWithSignalTests(TestCase):
    ...
    """
    Tests for L{twisted.application.chat._exitWithSignal}.
    """
